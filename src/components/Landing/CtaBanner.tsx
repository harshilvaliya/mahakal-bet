...
const Button: React.FC<ButtonProps> = ({ href, variant, children }) => {
  const baseStyles =
    "text-lg lg:text-xl font-bold rounded-xl cursor-pointer transition-all";
  const variantStyles = {
    primary:
      "bg-primary-400 hover:bg-primary-600 text-light border-transparent py-2 lg:py-4 px-4 lg:px-8",
    outline:
      "bg-transparent hover:!bg-primary-600 text-light border border-primary-600 py-[7px] lg:py-[15px] px-4 lg:px-8",
  };
...
const CtaBanner: React.FC = () => {
  return (
    <section
      className="py-12 md:py-[125px] px-4 bg-secondary-0 shape-grid"
    ...
    >
      <div className="max-w-[872px] mx-auto text-center px-4 md:px-8">
        ...
        <p
          className="text-lg font-medium text-neutralGray-500"
